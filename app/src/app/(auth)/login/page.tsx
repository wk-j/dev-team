        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <form action={loginWithGitHub}>
            <button
              type="submit"
              disabled={isPending}
              className="w-full flex items-center justify-center gap-2 px-4 py-2 border border-void-atmosphere rounded-lg text-text-bright hover:bg-void-atmosphere transition-colors disabled:opacity-50"
            >
...
function LoginFormSkeleton() {
  return (
    <div className="glass-panel p-8 animate-pulse">
      <div className="text-center mb-8">
        <div className="h-8 bg-void-atmosphere rounded w-48 mx-auto mb-2"></div>
        <div className="h-4 bg-void-atmosphere rounded w-64 mx-auto"></div>
      </div>
      <div className="space-y-4">
        <div className="h-12 bg-void-atmosphere rounded"></div>
        <div className="h-12 bg-void-atmosphere rounded"></div>
        <div className="h-12 bg-void-atmosphere rounded"></div>
      </div>
    </div>
